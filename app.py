...
        continue, and so the new vercel thing has to have all these features and look almost the same give me small small steps, and i would rather have1 full file instead of like 5 different files
